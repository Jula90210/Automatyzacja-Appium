...
class Test4Appium(unittest.TestCase):
    def setUp(self):
        desired_caps = {}
    ...
    def testDateOfBirthBelow16yo(self):
        ...
        self.assertTrue(set(['You must be at least 16 years old']) <= views_names)


if __name__ == 'main':
    suite = unittest.TestLoader().loadTestsFromTestCase(Test4Appium)
