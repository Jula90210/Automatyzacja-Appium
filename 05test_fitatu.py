...
class Test5Appium(unittest.TestCase):
    def setUp(self):
        desired_caps = {}
    ...
    def testHeightLowerThan120cm(self):
...
if __name__ == 'main':
    suite = unittest.TestLoader().loadTestsFromTestCase(Test5Appium)
